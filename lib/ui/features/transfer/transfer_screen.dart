...
class TransferScreen extends StatelessWidget {
  ...
  Widget _builder(BuildContext context, Wallets state) => SimpleScreen(
        title: "Transfer",
        ...
        contentBuilder: (_) => BlocProvider<TransferCubit>(
          ...
          child: BlocListener<TransferCubit, TransferState>(
            listener: (context, state) => state.sendState.fold(
                ...
                (s) => s.fold((e) {}, (sent) {
                      if (sent) {
                        context.go(Routes.wallets.fullPath);
                      }
                    })),
  ...
  Widget build(BuildContext context) {
    return uiDeps.simpleBuilder<Wallets>(
      ...
      loadedBuilder: (context, wallets) => _builder(context, wallets),
    );
  }
}
